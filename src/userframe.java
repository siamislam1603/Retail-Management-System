...
public class userframe extends javax.swing.JFrame {
        ...
        initComponents();
         try {
           ...
           Connection connection = DriverManager.getConnection(
            ...
            ResultSet r=statement.executeQuery("select username,position,userid from Userinfo");
            Usertable.setModel(DbUtils.resultSetToTableModel(r));
    ...
    private void initComponents() {
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8_user_shield_50px.png"))); // NOI18N
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 610, 430));
        ...
        jPanel2.add(deleteBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 0, 110, -1));
    ...
    private void deleteBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteBtnMouseClicked
        ...
        try {
           ...
           Connection connection = DriverManager.getConnection(
            ...
            Statement statement = connection.createStatement();
            r=statement.executeQuery("select username,position,userid from Userinfo");
            Usertable.setModel(DbUtils.resultSetToTableModel(r));
    ...
    private void addBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addBtnMouseClicked
        // TODO add your handling code here:
        Adduserframe1 f=new Adduserframe1();
        f.setSize(1366,728);
        dispose();
        f.setVisible(true);
    ...
    public void showtable(ResultSet r)
    {
